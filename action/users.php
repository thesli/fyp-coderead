...
<div id="area"></div>
	...
	?>
    	<h2>Managing <?= $userACL->getUsername($_GET['userID']); ?>:</h2>
        ... Some form to edit user info ...
        <h3>Roles for user:   (<a href="../ACL/admin/users.php?action=roles&amp;userID=<?= $_GET['userID']; ?>">Manage Roles</a>)</h3>
        <ul>
        ...
        <h3>Permissions for user:   (<a href="../ACL/admin/users.php?action=perms&amp;userID=<?= $_GET['userID']; ?>">Manage Permissions</a>)</h3>
        <ul>
        <? $perms = $userACL->perms;
     ...
     <h2>Manage User Roles: (<?= $userACL->getUsername($_GET['userID']); ?>)</h2>
	...
	?>
    	<h2>Manage User Permissions: (<?= $userACL->getUsername($_GET['userID']); ?>)</h2>
        <form action="../action/users.php" method="post">
            <table border="0" cellpadding="5" cellspacing="0">
            <tr><th></th><th></th></tr>
            <? 
